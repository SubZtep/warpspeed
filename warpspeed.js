...
function WarpSpeed(targetId, config) {
  ...
  this.WARP_EFFECT_LENGTH =
    config.warpEffectLength == undefined ? 5 : config.warpEffectLength < 0 ? 0 : config.warpEffectLength
...
WarpSpeed.prototype = {
  ...
  draw: function () {
    ...
    if (!this.PAUSED && isVisible(canvas)) {
      ...
      var rgb = "rgb(" + this.STAR_R + "," + this.STAR_G + "," + this.STAR_B + ")",
        rgba = "rgba(" + this.STAR_R + "," + this.STAR_G + "," + this.STAR_B + ","
